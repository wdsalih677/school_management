            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" class="form-control" value="{{ $grade->getTranslation('name','ar') }}" autocomplete="off" disabled>
                    </div>
                    <div class="col">
                        <label class="text-control">{{ trans('main_trans.grade_name_en') }} :</label>
                        <input type="text" class="form-control" value="{{ $grade->getTranslation('name','en') }}" autocomplete="off" disabled>
                    </div>
                </div>
            </div>
